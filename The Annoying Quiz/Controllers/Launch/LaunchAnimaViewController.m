  ...
  [UIView animateWithDuration:1
      ...
      completion:^(BOOL finished) {
        [UIView animateWithDuration:1
            ...
            completion:^(BOOL finished) {
              UIStoryboard *startSB =
                  [UIStoryboard storyboardWithName:@"Start" bundle:nil];
              StartViewController *startViewCtrl =
                  [startSB instantiateViewControllerWithIdentifier:
                               @"StartViewController"];
              [self.navigationController pushViewController:startViewCtrl
                                                   animated:NO];
